...
@Component({
  ...
  template: `<div class="navbar bg-base-100">
      ...
      <a
          routerLink="{{ appConstants.Routes.HOME }}"
          class="btn btn-ghost normal-case text-xl"
          >Stock Vue</a
        >
        <a
          routerLinkActive="btn-active"
          routerLink="{{ appConstants.Routes.OI_SCAN }}"
          class="btn btn-ghost normal-case text-xl"
          >OI Scan</a
        >
        ...
        <a
          routerLinkActive="btn-active"
          routerLink="{{ appConstants.Routes.OI_BUILD_UP }}"
          class="btn btn-ghost normal-case text-xl"
          >OI Buildup</a
        >
      ...
      <div class="navbar-end">
        <label class="swap swap-rotate">
          ...
          <input type="checkbox"  (change)="onModeChange($event)" />
